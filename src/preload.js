...
Preload.prototype = {
	...
	preload: function(){
		...
		this.game.load.spritesheet('minion_strongest', 'assets/minion_strongest.png', 32, 48);
		...
		this.game.load.image('spawnbutton_minion_strongest', 'assets/spawnbutton_minion_strongest.png', 40, 40);
	},
